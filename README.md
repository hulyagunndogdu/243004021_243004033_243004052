...
Bu proje, C# Windows Forms ve SQL Server kullanılarak geliştirilmiş bir hastane randevu sistemi uygulamasıdır.
...
## Tanıtım Videosu
Proje tanıtım videosuna repository içerisinde bulunan "Proje Tanıtım Videoları.mp4" dosyasından ulaşabilirsiniz
